...
export default function Navbar({ onToggleFavorites, favoritesCount = 0 }) {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-3 bg-white/30 backdrop-blur-xl border border-white/40 rounded-2xl shadow-sm">
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-lg font-bold text-gray-800 tracking-tight">Seoul Culture</span>
      </div>
